...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    DelayFileReader delayReader = new DelayFileReader();
    ...
    if (!file.equals("")) {
      ...
      try {
        ...
        Map<Integer, Integer> delayList = delayReader.readFile(file2);
