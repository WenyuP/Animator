...
public class AnimationFileReader {
  ...
  public <T> T readFile(String fileName, TweenModelBuilder<T> builder) throws
    ...
    while (sc.hasNext()) {
      ...
      switch (command) {
        ...
        case "plusShape":
          PlusShapeInfo pinfo = readPlusShapeInfo(sc);
          builder.addPlusShape(
                  pinfo.getName(),
  ...
  private PlusShapeInfo readPlusShapeInfo(Scanner sc) throws
          IllegalStateException, InputMismatchException {
    PlusShapeInfo info = new PlusShapeInfo();
  ...
  class PlusShapeInfo extends ShapeInfo {
    private float x;
    private float y;
    private float width;
    private float height;
    ...
    /**
     * Creates a PlusShapeInfo object that extends ShapeInfo.
     */
    PlusShapeInfo() {
      super();
      valueFlags.put("x", false);
